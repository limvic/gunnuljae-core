...
# 2026.06.12 뿌리 수술: main_safe 유니버스(67) vs JUDGE_STOCK_MAP(49) 전수 대조 →
# 이름 미매핑 18종목 전부 등록. 유니버스 확장 전까지 NAME-MISS 구조적으로 0건.
FALLBACK_NAMES = {
    "000720": "현대건설",
    "000810": "삼성화재",
    "003550": "LG",
...
ENGINE_VERSION = "2.3"   # /wave-alert/ping 에 노출 → 배포 확인용
